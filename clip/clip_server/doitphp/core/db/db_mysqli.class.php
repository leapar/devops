...
class db_mysqli extends Base {
    ...
    public function __construct($params = array()) {
        ...
        //handled by Colin
        $this->dbLink = $params['port'] ? @new mysqli($params['host'], $params['username'], $params['password'], $params['dbname'], $params['port'], '/tmp/mysql.sock') : @new mysqli($params['host'], $params['username'], $params['password'], $params['dbname']);
